...
public sealed class DevTermSessionBuilderTests
{
    ...
    {
        var result = DevTermSessionBuilder.Build(new CliOptions { Transport = "tcp", Host = "127.0.0.1", TcpPort = 23, Presenter = ["ascii", "hex", "ASCII"] });
    ...
    {
        var options = new CliOptions { Transport = "tcp", Host = "127.0.0.1", TcpPort = 23, Parser = "nope" };
    ...
    {
        var result = DevTermSessionBuilder.Build(new CliOptions { Transport = "tcp", Host = "127.0.0.1", TcpPort = 23, Presenter = ["decimal", "hex"] });
