...
| **Device > Edit Device Manifest...** | Opens the manifest editor (a non-modal window) to create, open, edit and save a device manifest with a live panel preview — see [`docs/specs/manifest-editor.md`](manifest-editor.md). Always enabled: it needs no connection | None | n/a |
